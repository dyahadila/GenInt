...
class Config:
    ...
    def from_args(self, args=sys.argv[1:]):
        ...
        parser.add_argument('--sigma', type=float, default=3.0, help='Number of stdevs to walk in visualize.py')
        ...
        parser.add_argument('--random_image_examplar_num', type=int, default=50, help='number for random image seed')
        parser.add_argument('--top_k_component_num', type=int, default=16, help='top k PCA component to use')
        parser.add_argument('--select_num', type=int, default=2, help='num of PCA selected')
        parser.add_argument('--trans_num_frames', type=int, default=5, help='top k PCA component to use')
        parser.add_argument('--start_num', type=int, default=0, help='range start')
        parser.add_argument('--end_num', type=int, default=1000, help='range end')
